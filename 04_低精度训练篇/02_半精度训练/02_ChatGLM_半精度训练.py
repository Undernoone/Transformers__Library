...
如果不进行调整，后续chat阶段会报错
"""
model = AutoModel.from_pretrained("THUDM/chatglm3-6b", trust_remote_code=True, torch_dtype=torch.bfloat16, load_in_8bit=True)
print(model)
...
model.enable_input_require_grad(True)
